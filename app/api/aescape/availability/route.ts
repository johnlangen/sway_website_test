// /api/aescape/availability/route.ts
...
export async function GET(req: Request) {
  ...
  // Aescape staff ID — same for both legacy (59-62) and new (92-95) session types
  url.searchParams.append("request.staffIds[0]", "100000040");
