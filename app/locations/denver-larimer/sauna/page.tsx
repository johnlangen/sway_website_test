      ...
      <section className="flex flex-col md:flex-row-reverse items-center justify-center px-6 md:px-16 pt-28 md:pt-36 pb-20 md:py-36 max-w-[1300px] mx-auto">
        ...
        >
          ...
          <p className="text-md md:text-lg text-gray-700 mt-4 leading-relaxed font-vance-text">
            Experience traditional sauna therapy at Sway Wellness Spa in downtown Denver.
            Sessions are designed for relaxation, recovery, and circulation support.
          </p>
      ...
      <section className="bg-[#F7F4E9] px-6 py-20">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-vance-bold text-[#113D33] mb-4">
            Sauna Safety & Research
          </h2>

          <p className="text-gray-700 text-sm md:text-base max-w-3xl mx-auto mb-10">
            Sauna use has been studied for cardiovascular health, stress reduction,
            and overall wellbeing. Benefits may vary by individual and should be
            approached with moderation and hydration.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            <a
              href="https://health.clevelandclinic.org/sauna-benefits"
              target="_blank"
            ...
            <a
              href="https://www.health.harvard.edu/heart-health/hot-baths-and-saunas-beneficial-for-your-heart"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-white rounded-xl shadow-md p-6 hover:shadow-xl transition"
            >
          ...
          <p className="text-xs text-gray-500 mt-10 max-w-3xl mx-auto">
            Sauna therapy is intended for generally healthy adults.
