...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical:
      "https://swaywellnessspa.com/locations/georgetown/enter-to-win/",
  },
  openGraph: {
    type: "website",
    url: "https://swaywellnessspa.com/locations/georgetown/enter-to-win/",
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 4,
      name: "Enter to Win",
      item: "https://swaywellnessspa.com/locations/georgetown/enter-to-win/",
    },
  ],
};
