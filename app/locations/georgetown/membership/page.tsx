  ...
  const schema = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        description:
          "Spa Club and Remedy Room memberships for Sway Georgetown starting at $89/month for founding members. Washington, DC location coming soon.",
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <motion.div className="text-center mb-12" {...fadeUp}>
          ...
          <p className="text-base md:text-lg text-gray-700 max-w-2xl mx-auto">
            Two membership tiers will be available at our Washington, DC location.
            Lock in your founding rate before Sway Georgetown opens.
          </p>
        </motion.div>
          ...
          <div className="space-y-3">
            <details className="bg-white rounded-xl p-4 group">
              ...
              <p className="mt-3 text-sm leading-relaxed opacity-80">
                Founding memberships lock in your rate today but don&apos;t bill until Sway Georgetown opens. You pay nothing until doors open.
              </p>
            </details>
            <details className="bg-white rounded-xl p-4 group">
              <summary className="font-semibold cursor-pointer list-none flex items-center justify-between">
