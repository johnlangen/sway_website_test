          ...
          <div className="space-y-3">
            <details className="bg-white rounded-xl p-4 group">
              ...
              <p className="mt-3 text-sm leading-relaxed opacity-80">
                Sway Georgetown will offer three tiers: Essential (signature 50-minute treatments), Premier (enhanced products and extended durations), and Ultimate (tech-enhanced premium treatments with LED, microcurrent, and more). Additional Remedy Room and Aescape robot massage memberships will also be available.
              </p>
            </details>
            <details className="bg-white rounded-xl p-4 group">
              <summary className="font-semibold cursor-pointer list-none flex items-center justify-between">
              ...
              <p className="mt-3 text-sm leading-relaxed opacity-80">
                Yes. Founding members will receive exclusive pricing before Sway Georgetown opens. Join the waitlist to be notified when founding memberships become available.
              </p>
            </details>
            <details className="bg-white rounded-xl p-4 group">
              <summary className="font-semibold cursor-pointer list-none flex items-center justify-between">
                When does Sway Georgetown open?
                <span className="text-lg group-open:rotate-45 transition-transform">+</span>
              </summary>
              <p className="mt-3 text-sm leading-relaxed opacity-80">
                Sway Georgetown is coming soon to Washington, DC. Waitlist members will be the first to know the exact date and will get priority access.
              </p>
            </details>
          </div>
        </motion.div>
