...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://swaywellnessspa.com/locations/knox-henderson/",
  },
  openGraph: {
    type: "website",
    url: "https://swaywellnessspa.com/locations/knox-henderson/",
    title: "Sway Knox/Henderson | Dallas Spa & Wellness Club | Coming Soon",
    description:
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 3,
      name: "Dallas",
      item: "https://swaywellnessspa.com/locations/knox-henderson/",
    },
  ],
};
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Sway Knox/Henderson is coming soon to 2323 Henderson Ave in Dallas. Sign up as a Founding Member at swaywellnessspa.com/locations/knox-henderson/founding-membership to get early access, exclusive pricing, and opening-day perks.",
      },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Founding Members receive exclusive pricing and priority booking before Sway Knox/Henderson opens. Benefits include VIP opening-day perks and guaranteed rates. Sign up at swaywellnessspa.com/locations/knox-henderson/founding-membership.",
      },
    },
    {
      "@type": "Question",
