    ...
    "@graph": [
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Dallas", item: "https://swaywellnessspa.com/locations/knox-henderson/" },
          { "@type": "ListItem", position: 4, name: "Gift Cards", item: "https://swaywellnessspa.com/locations/knox-henderson/gift-cards/" },
        ],
      },
      {
        "@type": "Product",
        name: "Sway Knox/Henderson Spa Gift Cards",
        description: "Wellness gift cards for Sway Knox/Henderson. Redeemable for massage, facials, and Remedy Room sessions once the Dallas location opens.",
