  ...
  "@graph": [
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: "https://swaywellnessspa.com/locations/knox-henderson/founding-membership/",
        },
      ],
    },
    {
      ...
      offers: {
        "@type": "Offer",
        url: "https://swaywellnessspa.com/locations/knox-henderson/founding-membership/",
...
export default function DallasFoundingMembershipPage() {
    ...
    try {
      const res = await fetch("/api/founding-member", {
        ...
        body: JSON.stringify({
          ...
          consentText: waitlistConsentText("knox-henderson"),
        }),
      });
  ...
  return (
    <div className="min-h-screen font-vance bg-[#F7F4E9]">
      ...
      <GiveawayBanner location="knox-henderson" />
      ...
      <section className="bg-[#F7F4E9] px-4 sm:px-6 pb-24">
        ...
        <motion.div
          ...
          whileInView="show"
          viewport={{ once: true }}
          className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6 items-stretch"
        >
          {memberships.map((m) => {
      ...
      <section className="bg-[#113D33] py-20 px-6">
        ...
        <motion.div
          ...
          whileInView="show"
          viewport={{ once: true }}
          className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5"
        >
          {treatments.map((t, i) => {
          ...
          {formStatus === "success" ? (
            ...
            >
              ...
              <p className="text-[11px] text-gray-400 leading-relaxed text-center">
                {waitlistConsentText("knox-henderson")} Membership pricing and perks
                are not yet final.
              </p>
            </motion.form>
          )}
