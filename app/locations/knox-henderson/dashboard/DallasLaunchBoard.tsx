...
export default function DallasLaunchBoard() {
  ...
  const bigStats: { label: string; value: number; href?: string }[] = [
    ...
    { label: "Founding page", value: bySource.founding, href: "/locations/knox-henderson/founding-membership" },
    { label: "Location page", value: bySource.locationPage, href: "/locations/knox-henderson" },
    { label: "Contest", value: bySource.contest, href: "/locations/knox-henderson/enter-to-win" },
  ];
  const miniStats = [
  ...
  const utmLink = campaignName.trim()
    ? `https://swaywellnessspa.com/locations/knox-henderson/founding-membership?utm_source=staci&utm_medium=qr&utm_campaign=${encodeURIComponent(
