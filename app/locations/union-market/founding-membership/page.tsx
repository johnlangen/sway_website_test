...
const memberships = [
  {
    ...
    benefits: [
      ...
      "Member-priced facials & massages",
  ...
  "@graph": [
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: "https://swaywellnessspa.com/locations/union-market/founding-membership/",
        },
      ],
    },
    {
      ...
      offers: {
        "@type": "Offer",
        url: "https://swaywellnessspa.com/locations/union-market/founding-membership/",
...
export default function GeorgetownFoundingMembershipPage() {
    ...
    try {
      const res = await fetch("/api/founding-member", {
        ...
        body: JSON.stringify({
          ...
          consentText: waitlistConsentText("union-market"),
        }),
      });
  ...
  return (
    <div className="min-h-screen font-vance bg-[#F7F4E9]">
      ...
      <GiveawayBanner location="union-market" />
          ...
          {formStatus === "success" ? (
            ...
            >
              ...
              <p className="text-[11px] text-gray-400 leading-relaxed text-center">
                {waitlistConsentText("union-market")} Membership pricing and
                perks are not yet final.
              </p>
            </motion.form>
          )}
