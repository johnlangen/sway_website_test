    ...
    "@graph": [
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Union Market", item: "https://swaywellnessspa.com/locations/union-market/" },
          { "@type": "ListItem", position: 4, name: "Membership", item: "https://swaywellnessspa.com/locations/union-market/membership/" },
        ],
      },
    ],
  };
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <motion.div className="text-center mb-12" {...fadeUp}>
          ...
          <p className="text-base md:text-lg text-gray-700 max-w-2xl mx-auto">
            ...
            Washington, DC location. Join the waitlist to be first in line for
          ...
          <div className="space-y-3">
            <details className="bg-white rounded-xl p-4 group">
              ...
              <p className="mt-3 text-sm leading-relaxed opacity-80">
                Sway Union Market will offer three tiers: Essential (signature 50-minute treatments), Premier (enhanced products and extended durations), and Ultimate (tech-enhanced premium treatments with LED, microcurrent, and more). Additional Remedy Room and Aescape robot massage memberships will also be available.
              </p>
            </details>
            <details className="bg-white rounded-xl p-4 group">
              <summary className="font-semibold cursor-pointer list-none flex items-center justify-between">
              ...
              <p className="mt-3 text-sm leading-relaxed opacity-80">
                Yes. Founding members will receive exclusive pricing before Sway Union Market opens. Join the waitlist to be notified when founding memberships become available.
              </p>
            </details>
            <details className="bg-white rounded-xl p-4 group">
              <summary className="font-semibold cursor-pointer list-none flex items-center justify-between">
                When does Sway Union Market open?
                <span className="text-lg group-open:rotate-45 transition-transform">+</span>
              </summary>
              <p className="mt-3 text-sm leading-relaxed opacity-80">
                Sway Union Market is coming soon to Washington, DC. Waitlist members will be the first to know the exact date and will get priority access.
              </p>
            </details>
          </div>
        </motion.div>
        ...
        <motion.div className="text-center mt-12" {...fadeUp}>
          <Link
            href="/locations/union-market/founding-membership"
