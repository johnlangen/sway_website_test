...
/* ------------------------------------------------------------------
   PLACEHOLDER CONTEST DETAILS — mirrors the Dallas contest.
   Confirm final prize/dates before promoting this page.
------------------------------------------------------------------ */
const CONTEST = {
  prizeTitle: "A Year of Wellness at Sway Union Market",
  prizeSummary:
    "Receive a monthly massage or facial for 12 months at Sway Union Market in Washington, DC.",
  prizeValue: "$1,700",
  endDate: "Sway Union Market Opening Day", // confirm specific date
...
/* ------------------------------------------------------------------
   PAGE
------------------------------------------------------------------ */
export default function UnionMarketEnterToWinPage() {
    ...
    <div className="bg-[#F7F4E9] text-[#113D33] font-vance">
      ...
      <section className="relative min-h-[100svh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 px-6 pt-28 md:pt-36 pb-20 text-center max-w-4xl mx-auto">
          ...
          >
            Union Market &middot; Washington, DC
          </motion.p>
      ...
      <section id="enter-form" className="px-6 py-16 md:py-20 bg-white scroll-mt-24">
        <div className="max-w-3xl mx-auto">
          ...
          <motion.div {...fadeUp}>
            <EnterToWinForm location="union-market" source="enter-to-win" />
          </motion.div>
          ...
          <details className="group">
            ...
            <div className="mt-4 text-xs text-[#113D33]/60 space-y-3 leading-relaxed">
              ...
              <p>
                ...
                monthly facial or massage for 12 months at Sway Union Market,
