  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "The Sway Edit covers massage therapy, skincare and facials, recovery science (cold plunge, sauna, compression therapy), wellness technology (Aescape AI robot massage, LED therapy, microcurrent), Denver lifestyle, bridal and bachelorette spa planning, and seasonal wellness guides.",
        },
      },
      {
        "@type": "Question",
