...
export default function TermsAndConditionsPage() {
  return (
    <div className="bg-[#F8F5F3] min-h-screen text-black px-6 pt-32 md:pt-40 pb-20 max-w-4xl mx-auto font-vance leading-relaxed">
      ...
      <h2 className="text-xl md:text-2xl font-semibold mt-10 mb-2">User Responsibilities</h2>
      <p className="mb-6">
        By using our site, you agree to:
        <br />- Provide accurate information when making a purchase or registration.
        <br />- Not use the site for unlawful purposes.
        <br />- Not interfere with the operation of the site or access to other users.
      </p>

      <h2 className="text-xl md:text-2xl font-semibold mt-10 mb-2">Orders and Payments</h2>
      <p className="mb-6">
      ...
      <h2 className="text-xl md:text-2xl font-semibold mt-10 mb-2">Memberships</h2>
      <p className="mb-6">
      ...
      <h2 className="text-xl md:text-2xl font-semibold mt-10 mb-2">Cancellations and Refunds</h2>
      <p className="mb-6">
      ...
      <h2 className="text-xl md:text-2xl font-semibold mt-10 mb-2">Intellectual Property</h2>
      <p className="mb-6">
      ...
      <h2 className="text-xl md:text-2xl font-semibold mt-10 mb-2">Links to Third-Party Sites</h2>
      <p className="mb-6">
      ...
      <h2 className="text-xl md:text-2xl font-semibold mt-10 mb-2">Disclaimer of Warranties</h2>
      <p className="mb-6">
      ...
      <h2 className="text-xl md:text-2xl font-semibold mt-10 mb-2">Limitation of Liability</h2>
      <p className="mb-6">
      ...
      <h2 className="text-xl md:text-2xl font-semibold mt-10 mb-2">Indemnification</h2>
      <p className="mb-6">
      ...
      <h2 className="text-xl md:text-2xl font-semibold mt-10 mb-2">Governing Law</h2>
      <p className="mb-6">
      ...
      <h2 className="text-xl md:text-2xl font-semibold mt-10 mb-2">Changes to These Terms</h2>
      <p className="mb-6">
