...
export const metadata: Metadata = {
  title: { absolute: "Father's Day Spa Gift Cards | Sway Wellness Spa Denver" },
  description:
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Aescape is an AI-powered, fully personalized full-body robot massage. The guest lies face-down, the machine scans their back, and delivers consistent pressure for 15 to 60 minutes. Sway has the first Aescape in Colorado. The 60-minute session is $99 first visit (Mon-Fri, locals only, code FTVO40).",
      },
    },
    {
      "@type": "Question",
