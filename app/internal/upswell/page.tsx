...
const DAILY_STATUS = {
  ...
  pending: [
    ...
    {
      label: "Heather: update Upswell.com Squarespace 'Book' button → Sway location pages",
      detail: "LOW PRIORITY. Builds muscle-memory shift + SEO consolidation before signage flips. Both URLs work fine independently if she doesn't get to it. Ask once, don't push.",
      owner: "Heather (low priority)",
    },
    {
