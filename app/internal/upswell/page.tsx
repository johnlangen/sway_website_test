...
const DAILY_STATUS = {
  ...
  pending: [
    ...
    },
    {
      ...
      detail: "John will embed in Sway location pages (/locations/denver-rino/book and /locations/denver-central-park/book). Tenant=upswellstudio, RiNo location=48717, CP location=48718, schedule view=48541 (already verified from production URL).",
      owner: "Heather",
    },
    {
      label: "Heather: update Upswell.com 'Book' button → Sway location pages",
      detail: "Builds muscle-memory shift to swaywellnessspa.com domain ahead of July 1 brand launch.",
      owner: "Heather",
    },
    {
...
const WEEK_PLAN = [
  {
    ...
    items: [
      ...
      "John: accept GBP owner invites when Heather sends",
      "John: update GBP website URL → swaywellnessspa.com/locations/... + phone + transition post (NAME stays Upswell)",
      "John: follow up Michael Calderon (Mindbody) on Stripe migration method",
      "John: ask Heather for MT booking widget embed code (Heather offered)",
      "Heather: send 'last chance' email from her voice (MT maintenance context — final Heather-voice send)",
      "Heather: redirect Upswell.com 'Book' button → Sway location pages",
      "NO public messaging. NO signage. NO website 'open' flip. Members notice nothing.",
    ],
  },
  {
...
const BLOCKERS_P0 = [
  ...
  "Build /locations/denver-rino/book + /locations/denver-central-park/book with embedded MT widget (coding brief delivered).",
