...
- **Signature Massage pressure**: Signature Massage is **light to medium pressure** — say so in every description. Do NOT say "tailored to you," "customized to your pressure preference," or anything implying deep/customizable pressure (front-desk report July 2026: guests booked Signature expecting deep work). Deep pressure = Deep Tissue (Premier/Ultimate).
...
- **First-visit offers are LOCALS ONLY (HARD RULE, Larimer)**: The first-visit deals (FTVO40 — $40 off first massage/facial/60-min Aescape; FTVORR — $25 first Remedy Room) are restricted to **locals only**, in addition to first-time-guest + day-of-week limits. Every surface that mentions these offers — offer cards, page copy, meta descriptions, FAQ answers, JSON-LD Offer structured data, ad copy — MUST state "locals only." Never describe them as available to any/all guests or tourists. (Rationale: first-visit discounts are a local-acquisition/membership funnel; tourist redemption is margin giveaway with no repeat value.)
