...
class JoinTheClubPageLocal extends StatefulWidget {
  @override
  _JoinTheClubPageLocalState createState() => _JoinTheClubPageLocalState();
}

class _JoinTheClubPageLocalState extends State<JoinTheClubPageLocal> {
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    ...
                    'Exclusive to the Larimer Community:  Special access to Sway’s most exclusive founding member offer—a \$300 value! Our \$99/month membership includes an enhanced facial or massage. PLUS, with this offer, enjoy 6 FREE visits to the Remedy Room, featuring a sauna, cold plunge, LED light therapy, and Normatec lymphatic drainage boots.',
                    style: TextStyle(
                      color: Color(0xFF113D33),
                      fontSize: isMobile ? 16 : 18,
                      fontFamily: 'Vance-Text',
                ...
                Padding(
                  ...
                  child: Text.rich(
                    TextSpan(
                      ...
                      children: [
                        TextSpan(
                          text: 'MUST ENTER “SwayLocal” AT CHECKOUT ', 
                          style: TextStyle(
